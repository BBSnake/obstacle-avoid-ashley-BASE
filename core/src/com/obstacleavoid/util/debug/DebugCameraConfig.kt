...
class DebugCameraConfig {
    ...
    val isResetJustPressed: Boolean
        get() = Gdx.input.isKeyJustPressed(resetKey)

    val isLogJustPressed: Boolean
        get() = Gdx.input.isKeyJustPressed(logKey)
    ...
    companion object {
        private val log = Logger(DebugCameraConfig::class.java.name, Logger.DEBUG)
        ...
        private val DEFAULT_MAX_ZOOM_IN = 0.20f
